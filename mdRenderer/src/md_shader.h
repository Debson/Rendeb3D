...
public:
	...
	mdShader();
	mdShader(const GLchar *vertexPath, const GLchar *fragmentPath, const GLchar *geometryPath = nullptr);
	...
	void setMat4(const std::string &name, glm::mat4 &mat, bool transpose = false) const;
